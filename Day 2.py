...
def f(t):
    ...
    s=''
    for i in l:
        if levenshtein(i[2],t)<m:
            m=levenshtein(i[2],t)
            s=i
    return (t,levenshtein(s[2],t),s[2])

k=['tckmn', 'hrgrv', 'boboquack', 'ffao', 'padi', 'idontknow', 'linus', 'chaoticiak', 'betaveros', 'zimonze', 'tinaun', 'notquiteamish', 'adalbert', 'lovelyfiftyone', 'lovemathboy', 'flatluigi', 'manypinkhats']

for t in k:
    print(f(t)[1]/len(f(t)[0]),f(t)[0],f(t)[1],f(t)[2])
